...
-- BEGIN /COMMIT permet de s'assurer que la création des tables se fait en une seule Transaction
-- BEGIN /COMMIT ensures that the creation of tables is done in a single Transaction
